                ...
                <div class="panel-body">
                    <form action="admin/update.do" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="login" value="${requestScope.admin.login}" class="form-control"
                                   id="InputLogin" placeholder="请输入登陆账号">
                        </div>
                        <div class="form-group">
                            <label for="InputUserNmae">用户昵称</label>
                            <input type="text" name="userName" value="${requestScope.admin.userName}"
                                   class="form-control" id="InputUserNmae" placeholder="请输入用户名称">
                        </div>
                        <div class="form-group">
